...
public class T003Button {
    ...
    public void checkRegisterButtonIsCorrect() {
        Matcher<View> parent = withChild(withText("Crear usuario"));
        Espresso.onView(withText("Crear usuario")).check(matches(withClassName(containsString("Button"))));
        Espresso.onView(withText("Crear usuario")).check(isBottomAlignedWith(parent));
        Espresso.onView(withText("Crear usuario")).check(isLeftAlignedWith(parent));
        Espresso.onView(withText("Crear usuario")).check(isRightAlignedWith(parent));
        Espresso.onView(withText("Crear usuario")).check(hasDeclaredId());
    }
