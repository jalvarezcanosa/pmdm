...
@LargeTest
public class T016SecondFragment {
    ...
    public void checkCorrectImageShownAfterClick() {
        ...
        Matcher<View> contentDescription = withContentDescription("Otro Digimon poderoso");
    ...
    public void checkCorrectImageShownAfterClickAndNotOther() {
        ...
        Matcher<View> contentDescription2 = withContentDescription("Otro Digimon poderoso");
